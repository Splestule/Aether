...
import { d as j } from './chunk-KCR7AORG.js';
import { c as g } from './chunk-QDJTHWTA.js';
import { a as i } from './chunk-2YWR3G22.js';
import { b as n } from './chunk-HTSQLHXI.js';
import { e as b } from './chunk-JDAHMWM5.js';
function F(r, o, t) {
  return (
    t < 0 && (t += 1),
    t > 1 && (t -= 1),
    t * 6 < 1 ? r + (o - r) * 6 * t : t * 2 < 1 ? o : t * 3 < 2 ? r + (o - r) * (2 / 3 - t) * 6 : r
  );
}
function e(r, o, t, f) {
...
e.fromBytes = function (r, o, t, f, C) {
  return (
    ...
    b(C) ? ((C.red = r), (C.green = o), (C.blue = t), (C.alpha = f), C) : new e(r, o, t, f)
  );
};
...
e.fromHsl = function (r, o, t, f, C) {
  ...
  return b(C) ? ((C.red = m), (C.green = s), (C.blue = O), (C.alpha = f), C) : new e(m, s, O, f);
};
e.fromRandom = function (r, o) {
  ...
  return b(o) ? ((o.red = t), (o.green = f), (o.blue = C), (o.alpha = m), o) : new e(t, f, C, m);
};
...
e.prototype.toBytes = function (r) {
  ...
  return b(r) ? ((r[0] = o), (r[1] = t), (r[2] = f), (r[3] = C), r) : [o, t, f, C];
};
