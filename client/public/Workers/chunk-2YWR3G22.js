...
import { a as n, b as a } from './chunk-HTSQLHXI.js';
import { c as E, d as I, e as o } from './chunk-JDAHMWM5.js';
var d = E((_, m) => {
  var f = function (t) {
  ...
  f.prototype.init_by_array = function (t, i) {
    var e, s, h;
    for (this.init_seed(19650218), e = 1, s = 0, h = this.N > i ? this.N : i; h; h--) {
      var u = this.mt[e - 1] ^ (this.mt[e - 1] >>> 30);
      ((this.mt[e] =
        (this.mt[e] ^ (((((u & 4294901760) >>> 16) * 1664525) << 16) + (u & 65535) * 1664525)) +
        t[s] +
        s),
        (this.mt[e] >>>= 0),
        e++,
    ...
    for (h = this.N - 1; h; h--) {
      ...
      ((this.mt[e] =
        (this.mt[e] ^
          (((((u & 4294901760) >>> 16) * 1566083941) << 16) + (u & 65535) * 1566083941)) -
        e),
        (this.mt[e] >>>= 0),
        e++,
        e >= this.N && ((this.mt[0] = this.mt[this.N - 1]), (e = 1)));
...
r.fastApproximateAtan = function (t) {
  return (a.typeOf.number('x', t), t * (-0.1784 * Math.abs(t) - 0.0663 * t * t + 1.0301));
};
