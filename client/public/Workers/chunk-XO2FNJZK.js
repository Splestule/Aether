...
import { a as _ } from './chunk-CM5O7VPK.js';
import { j as U } from './chunk-IB27QQGF.js';
import { b as Z } from './chunk-RGFEE67W.js';
import { a as v, c as N } from './chunk-KCR7AORG.js';
import { a as n, b as A } from './chunk-QDJTHWTA.js';
import { a as on } from './chunk-2YWR3G22.js';
import { a as en, b as h } from './chunk-HTSQLHXI.js';
import { e as x } from './chunk-JDAHMWM5.js';
function W(e) {
...
W.prototype.unproject = function (e, t) {
  ...
  let o = this._oneOverSemimajorAxis,
    ...
    r = e.y * o,
    d = e.z;
  return x(t) ? ((t.longitude = c), (t.latitude = r), (t.height = d), t) : new v(c, r, d);
};
var V = W;
function sn(e, t) {
...
a.fromPoints = function (e, t) {
  ...
  return (
    l < D ? (n.clone(p, t.center), (t.radius = l)) : (n.clone(B, t.center), (t.radius = D)),
    t
  );
};
var rn = new V(),
...
a.fromVertices = function (e, t, o, c) {
  if ((x(c) || (c = new a()), !x(e) || e.length === 0))
    return ((c.center = n.clone(n.ZERO, c.center)), (c.radius = 0), c);
  ((t = t ?? n.ZERO), (o = o ?? 3), h.typeOf.number.greaterThanOrEquals('stride', o, 3));
  let r = $;
  ...
  return (
    P < M ? (n.clone(l, c.center), (c.radius = P)) : (n.clone(R, c.center), (c.radius = M)),
    c
  );
};
a.fromEncodedCartesianVertices = function (e, t, o) {
  ...
  return (
    j < R ? (n.clone(S, o.center), (o.radius = j)) : (n.clone(D, o.center), (o.radius = R)),
    o
  );
};
...
a.projectTo2D = function (e, t, o) {
  ...
  let c = t.ellipsoid,
    ...
    d = e.radius,
    f;
  n.equals(r, n.ZERO) ? (f = n.clone(n.UNIT_X, an)) : (f = c.geodeticSurfaceNormal(r, an));
