...
import { a as _ } from './chunk-2A2JFXXO.js';
import { a as te } from './chunk-33M5C4LG.js';
import { h as Z, i as fe } from './chunk-IB27QQGF.js';
import { a as ie, b as j } from './chunk-RGFEE67W.js';
import { a as se, b as ee } from './chunk-KCR7AORG.js';
import { a as e, b as O } from './chunk-QDJTHWTA.js';
import { a as Q } from './chunk-2YWR3G22.js';
import { a as le } from './chunk-HTSQLHXI.js';
import { e as $ } from './chunk-JDAHMWM5.js';
...
function v(r, n, a, o, t, c, f, l) {
  ...
  ((oe = O.fromRotationZ(S, oe)),
    (he.z = c),
    (H = j.multiplyTransformation(H, j.fromRotationTranslation(oe, he, Me), H)));
  let d = Ne;
  d[0] = f;
  for (let x = 0; x < l; x++)
...
function pe(r, n, a, o, t, c, f, l, m, s) {
  let S = e.angleBetween(e.subtract(n, r, I), e.subtract(a, r, W)),
    ...
    x;
  t
    ? (x = O.fromQuaternion(Z.fromAxisAngle(e.negate(r, I), S / (d + 1), ge), we))
...
R.computePositions = function (r, n, a, o, t) {
  ...
  for (let U = 1; U < i - 1; U++) {
    ...
    if (((M = r[U + 1]), p.equals(M))) {
      ue('Positions are too close and are considered equivalent with rounding error.');
      continue;
    }
