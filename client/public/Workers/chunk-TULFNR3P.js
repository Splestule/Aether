...
import { a as P, c as B } from './chunk-KCR7AORG.js';
import { a as y } from './chunk-QDJTHWTA.js';
import { a as L } from './chunk-2YWR3G22.js';
import { b as q } from './chunk-HTSQLHXI.js';
...
function Z(n, a, t, e, f, m, _) {
  ...
  do {
    ...
    let z = o - S * d;
    ((O = Math.sqrt(i * i * g * g + z * z)), (s = h + c * d), (w = Math.atan2(O, s)));
    let D;
  ...
  let v = (H * (a * a - t * t)) / (t * t),
    ...
    F = b * b,
    J = I * O * (b + (I * (s * (2 * F - 1) - (I * b * (4 * O * O - 3) * (4 * F - 3)) / 6)) / 4),
    K = t * W * (w - J),
    Q = Math.atan2(i * g, o - S * d),
    V = Math.atan2(l * g, o * d - S);
  ((n._distance = K), (n._startHeading = Q), (n._endHeading = V), (n._uSquared = v));
}
var $ = new y(),
  x = new y();
function N(n, a, t, e) {
...
E.prototype.interpolateUsingSurfaceDistance = function (n, a) {
  ...
  return T(a)
    ? ((a.longitude = this._start.longitude + H), (a.latitude = u), (a.height = 0), a)
